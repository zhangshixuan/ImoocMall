        ...
        <div class="confirm-tips">
          ...
          <ul>
            ...
            <li class="regi_form_input noMargin">
              ...
              <input v-model="userPwd" type="password" tabindex="2" name="password" placeholder="Password" class="regi_login_input regi_login_input_left login-input-no input_text" @keyup="login">
            </li>
          </ul>
        </div>
...
<script>
  ...
  export default {
    ...
    methods:{
      checkLogin(){
        axios.get('/users/checkLogin').then((respose)=>{
      ...
      logout(){
        axios.post("/users/logout").then((respose)=>{
          let res = respose.data;
          if(res.status == '0'){
            this.nickName = ""
          }
